  ...
  return (
    <Dialog
      ...
      actions={
        <>
          ...
          <Button type="button" onClick={handleSave} disabled={!url.trim()} className={dialogStyles.primaryButton}>
            บันทึก
          </Button>
        </>
      }
    >
      <div className={styles.body}>
        <Label htmlFor={inputId} className={styles.label}>URL ไฟล์เสียง</Label>
        <Input
          id={inputId}
          type="url"
          value={url}
        ...
        />
        <p className={styles.hint}>รองรับไฟล์เสียงที่เบราว์เซอร์เล่นได้ เช่น MP3, WAV, OGG และ M4A</p>
